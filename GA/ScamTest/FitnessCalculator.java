...
public class FitnessCalculator{
  ...
  public static void main(String[] args) {
    ...
    char[][]shreddedDocument = getShreddedDocument("ScamTest/document1-shredded.txt"); //This reads a -shredded.txt file from disk 
    ...
    int[] perm4 = {11, 13, 1, 6, 12, 0, 14, 5, 10, 4, 3, 8, 9, 2, 7};
    ...
    shreddedDocument = getShreddedDocument("ScamTest/SillyExample-shredded.txt");
